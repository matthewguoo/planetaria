...
# Shared primitives live in research_common (phase-14 §2). The underscore
# aliases keep every `from research_llm_contamination import _spy_daily`
# already written working; new code imports research_common directly.
...
from research_common import CLOSE_MIN, ENTRY_MIN, PROVENANCE, timing_ok  # noqa: E402, F401
from research_common import bars_for as _bars_for  # noqa: E402, F401
...
# PROVENANCE, ENTRY_MIN, CLOSE_MIN and timing_ok() moved to research_common
# (phase-14 §2); they are re-exported above for the callers that grew up here.
...
def compute_arms(args) -> dict:
    ...
    """
    from research_holding_period import resolve
...
# _spy_daily moved to research_common.spy_daily (phase-14 §2); the alias at
# the top of this file keeps the old name importable.
